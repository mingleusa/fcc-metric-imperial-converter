  ...
  test('Convert a valid input such as 10L: GET request to /api/convert.', function(done) {
    chai
      ...
      .end(function(err, res) {
        ...
        assert.approximately(res.body.returnNum, 10 / 3.78541, 0.00001);
        assert.equal(res.body.string, '10 liters converts to ' + res.body.returnNum + ' gallons');
        done();
      });
  });
  ...
  test('Convert with no number such as kg: GET request to /api/convert.', function(done) {
    chai
      ...
      .end(function(err, res) {
        ...
        assert.approximately(res.body.returnNum, 1 / 0.453592, 0.00001);
